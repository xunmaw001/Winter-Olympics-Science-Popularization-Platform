...
public class DiscussdongaohuixiangmuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussdongaohuixiangmuEntity discussdongaohuixiangmu,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussdongaohuixiangmuEntity discussdongaohuixiangmu, 
		HttpServletRequest request){
        EntityWrapper<DiscussdongaohuixiangmuEntity> ew = new EntityWrapper<DiscussdongaohuixiangmuEntity>();
		PageUtils page = discussdongaohuixiangmuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussdongaohuixiangmu), params), params));
        return R.ok().put("data", page);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussdongaohuixiangmuEntity> wrapper = new EntityWrapper<DiscussdongaohuixiangmuEntity>();
		if(map.get("remindstart")!=null) {
