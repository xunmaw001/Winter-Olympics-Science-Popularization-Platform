<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="视频来源" prop="shipinlaiyuan">
          <el-input v-model="ruleForm.shipinlaiyuan" 
              placeholder="视频来源" clearable  :readonly="ro.shipinlaiyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="视频来源" prop="shipinlaiyuan">
              <el-input v-model="ruleForm.shipinlaiyuan" 
                placeholder="视频来源" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shipin = true;
          ...
          if(o=='shipinlaiyuan'){
            this.ruleForm.shipinlaiyuan = obj[o];
	    this.ro.shipinlaiyuan = true;
            continue;
          }
          if(o=='fabushijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jingcaishipin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jingcaishipinCrossAddOrUpdateFlag = false;
						 this.parent.search();
